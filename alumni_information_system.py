...
def introduction():
    msg = '''
          ...
          If you have any query or suggestions please contact me at dasdebanna8@gmail.com \n\n\n\n'''
    for x in msg:
        print(x, end='')
        time.sleep(0.002)
...
def made_by():
    msg = ''' 
            Alumni information system made by       : DEBANNA DAS
            Roll No                                 : ###########
            School Name                             : BIRLA HIGH SCHOOL
            session                                 : 2020-21
